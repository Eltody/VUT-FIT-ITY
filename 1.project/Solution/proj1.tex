...
\begin{document}
	...
	\twocolumn[
  		\begin{@twocolumnfalse}
  			\vspace{0.73cm}
    			\begin{center}
				{\LARGE
					Typografie a publikování - 1. projekt \\ \bigskip
				}
				{\large
					Tomáš Zaťko \\ xzatko02@stud.fit.vutbr.cz
				}
			\end{center}    
			\vspace{0.7cm}
  		\end{@twocolumnfalse}
    ...
    \hspace{0.36cm}
    Čím více \emph{druhů}, \textbf{řezů}, {\huge velikostí}, \textcolor{blue} {barev} písma a jiných \textcolor{red}{\scriptsize EFEKTŮ} \underline{použijeme}, tím \textcolor{orange} {pro\-fe\-si\-o\-ná\-lně\-ji} bude \fontfamily{pzc}\selectfont {\Large dokument} \fontfamily{cmr}\selectfont vypadat. {\tiny Čtenář} tím bude vždy {\Huge \textbf{nadšen!}}
    \medskip
    \end{adjustwidth}
    ...
    Česká sazba se oproti okolnímu světu v některých aspektech mírně liší. Jednou z odlišností je sazba uvozovek. Uvozovky se v češtině používají převážně pro zobrazení přímé řeči, zvýraznění přezdívek a ironie. V češtině se používají uvozovky typu \uv{9966} místo anglických \textquotedblleft{uvozovek}\textquotedblright. Lze je sázet připravenými příkazy nebo při použití UTF-8 kódování i přímo.
